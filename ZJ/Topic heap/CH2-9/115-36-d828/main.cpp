...
{
    int m_00,m_01,m_02,m_03;
}Matrix;
inline Matrix multiply(Matrix A,Matrix B)
{
    Matrix C;
    C.m_00=(A.m_00*B.m_00+A.m_01*B.m_02)%MOD;
    C.m_01=(A.m_00*B.m_01+A.m_01*B.m_03)%MOD;
    C.m_02=(A.m_02*B.m_00+A.m_03*B.m_02)%MOD;
    C.m_03=(A.m_02*B.m_01+A.m_03*B.m_03)%MOD;
    return C;
}
