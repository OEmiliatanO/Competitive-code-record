...
//const double ALPHA = 0.75;  // 某種神奇的參數，防複雜度壞掉
//const double LOG_ALPHA = log2( 1.0 / ALPHA );  // 某種神奇的參數，防複雜度壞掉
class KD_TREE {
public:
    struct Point {
      static int kD;
